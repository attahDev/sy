...
export default function MRPreviousReports({ onSelect }: { onSelect?: (ideaId: string) => void }) {
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {ideas.map((idea) => {
          ...
          return (
            ...
            >
              <div>
                <p className="text-xs font-extrabold tracking-[0.08em] text-[#001F3F] uppercase">{idea.business_idea}</p>
